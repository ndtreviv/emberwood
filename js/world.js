...
World.LEVELS = [
  ...
  /* The deep and the ash: kills that pay for the deeper shop stock.  The
     three of the Sunken Depths were once ten times hardier than they began.
     They now stand two and a half times weaker than that, so the chapter
     keeps its own climb without holding a player up. */
  { name: 'TIDEWRACK', taker: 'THE TIDE TAKES', sub: 'THE TIDE WARDEN', theme: 'shore', enemyHp: 4,
    coinScale: 7, coinBonus: 2, bossHp: 36,
  ...
  { name: 'DROWNED HALL', taker: 'THE DEEP TAKES', sub: 'THE KRAKEN MAW', theme: 'drowned', enemyHp: 5,
    coinScale: 9, coinBonus: 3, bossHp: 44,
  ...
  { name: 'THE TRENCH', taker: 'THE TRENCH TAKES', sub: 'THE LEVIATHAN', theme: 'abyss', enemyHp: 6,
    coinScale: 12, coinBonus: 4, bossHp: 52,
